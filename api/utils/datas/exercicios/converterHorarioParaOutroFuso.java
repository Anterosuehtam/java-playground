...
Crie um programa que converta o horário atual do sistema (fuso horário padrão) para o fuso
horário de Sydney (Australia/Sydney) e exiba apenas as horas e os minutos. Dica: Utilize o
metodo withZoneSameInstant() para realizar a conversão.

*/
public class converterHorarioParaOutroFuso {
    static void main(String[] args) {
        ZonedDateTime horarioSistema = ZonedDateTime.now();

        ZonedDateTime horarioSydney = horarioSistema
