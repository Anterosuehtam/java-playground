...
/*Imagine que você está desenvolvendo um sistema para um banco digital,
onde todas as operações financeiras precisam ser tratadas de forma uniforme,
mas cada uma com seu comportamento específico. O banco deseja que, independentemente
do tipo de operação (depósito, saque, etc.), todas sigam a mesma estrutura básica para
facilitar a manutenção e expansão do sistema.

Crie um programa que:

Tenha uma interface AcaoBancaria com o metodo executar(), que representa o contrato que toda operação bancária deve seguir.
