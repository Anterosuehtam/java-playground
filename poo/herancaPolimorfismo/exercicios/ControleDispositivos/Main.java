package poo.herancaPolimorfismo.exercicios.ControleDispositivos;
...
o usuário receba uma mensagem, informando se a ação foi realmente executada ou se o dispositivo já estava no estado desejado.
...
Se o dispositivo estiver desligado e o metodo ligar() for chamado, ele deve mudar o
estado para ligado e exibir a mensagem: "Luz ligada." ou "Ar-condicionado ligado."
