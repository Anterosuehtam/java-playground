package poo.herancaPolimorfismo.exercicios.EnviandoMensagens;
/*Você está desenvolvendo um sistema de comunicação para uma
plataforma de colaboração em equipe. Esse sistema precisa lidar
com diferentes cenários de envio de mensagens.
